...
public enum HystrixPropertiesSetter
{
    ...
    public HystrixCommand.Setter newSetter( String hystrixGGroupKey,
    ...
    {
        return HystrixCommand.Setter.withGroupKey( HystrixCommandGroupKey.Factory.asKey( hystrixGGroupKey ) )
                ...
                .andCommandPropertiesDefaults( HystrixCommandProperties.Setter()
                        ...
                        .withMetricsRollingStatisticalWindowInMilliseconds( metricsRollingStatsTimeInMillisecond ) );
    }
}
